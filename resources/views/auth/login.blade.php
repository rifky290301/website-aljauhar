              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Selamat datang <br> Santri Al-Jauhar!</h1>
                  </div>
                  <form method="POST" action="{{ route('login') }}">
                    ...
                    <button type="submit" style="background: #009b4c" class="btn btn-user btn-block text-white">
                      Login
                    </button>
                  </form>
                </div>
