...
<div class="mb-2 d-flex justify-content-between">
  <h1 class="h3 text-gray-800">Tabel biografi</h1>
  <a href="/admin/biografi/tambah" class="btn btn-primary btn-icon-split">
    <span class="icon text-white-50">
      <i class="fas fa-plus"></i>
    </span>
    <span class="text">Tambah biografi</span>
  </a>
</div>
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Tabel biografi</h6>
  </div>
  <div class="card-body">
