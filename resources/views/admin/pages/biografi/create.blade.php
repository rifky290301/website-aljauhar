...
@section('content')
<h1 class="h3 mb-2 text-gray-800">Buat biografi</h1>
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Buat biografi</h6>
  </div>
  <div class="card-body">
    <form action="/admin/biografi" method="post" enctype="multipart/form-data">
      @csrf
      ...
      <div class="form-group">
        ...
        <textarea name="biography" id="biography" rows="3">{{ old('biography') }}</textarea>
      </div>
      <div class="form-group">
        <label for="position">Jabatan<span class="required-star">*</span></label>
        <input value="{{ old('position') }}" name="position" type="text" class="form-control @error('position') is-invalid @enderror form-control" id="position" placeholder="jabatan..." autofocus>
      </div>
      <div class="form-group">
